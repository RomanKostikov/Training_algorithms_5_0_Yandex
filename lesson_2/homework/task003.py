...
def calculate_max_rope_difference(N, lengths):
    sum_prev = 0
    max_len_rope = 0
    answer = -1
...
def main():
    ...
    result = calculate_max_rope_difference(N, lengths)
    print(result)
